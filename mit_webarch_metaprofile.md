...
| Standard usage for DDC | For MIT records, note any restrictions based on the [Institute Records Access Policy](https://libraries.mit.edu/distinctive-collections/institute-records-access-statement/). For manuscript collections, note any restrictions based on the donor agreement for new collections or the access note in the finding aid for existing collections. |
